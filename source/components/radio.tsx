...
type RadioGroupProps<TTag extends ElementType = 'div', TType = string> = {
  className?: string;
} & Omit<Headless.RadioGroupProps<TTag, TType>, 'as' | 'className'>;

export function RadioGroup<TTag extends ElementType = 'div', TType = string>(
...
type RadioFieldProps = {className?: string} & Omit<
  Headless.FieldProps,
  'as' | 'className'
>;
...
type RadioProps<TTag extends ElementType = 'span', TType = string> = {
  color?: Color;
  className?: string;
} & Omit<Headless.RadioProps<TTag, TType>, 'as' | 'className' | 'children'>;

export function Radio<TTag extends ElementType = 'span', TType = string>(
  props: RadioProps<TTag, TType>
): JSX.Element {
  const {color = 'dark/zinc', className, ...rest} = props;
  return (
    <Headless.Radio
      data-slot="control"
      {...rest}
